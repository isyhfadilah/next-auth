...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className={cn('flex flex-col space-y-2', containerClass, type === 'hidden' && 'hidden')}>
      {label && (
        <label className={cn('text-left mb-1 text-#6c757d', theme.labelColor, labelClassname)}>
      ...
      <div className="relative">
        ...
        <input
          type={type}
          className={cn(
            'px-3 py-3 focus:border-green-tea rounded focus:outline-none text-#8C8CA1 border-2 w-full text-base disabled:border-opacity-10 disabled:text-opacity-10',
